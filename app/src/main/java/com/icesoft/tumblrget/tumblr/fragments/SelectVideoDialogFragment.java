...
public class SelectVideoDialogFragment extends DialogFragment
{
    ...
    public static SelectVideoDialogFragment newInstance(String json)
    {
        SelectVideoDialogFragment fragment = new SelectVideoDialogFragment();
    ...
    class Adapter extends RecyclerView.Adapter{
        ...
        {
            TumblrResponseJson response = App.getInstance().getGson().fromJson(json, TumblrResponseJson.class);
            if(response != null &&
