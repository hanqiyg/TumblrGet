...
public class MyUtils
{
    ...
    public static final long EB = 1024L * PB;
    private static final String FORMAT = "%-3.3f";
    ...
    public static String getDataSizeString(long size)
    {
        if(size < KB){
            ...
            return String.format(FORMAT,(float)size/KB) + " kB";
        }else if(size < GB){
            return String.format(FORMAT,(float)size/MB) + " MB";
        }else if(size < TB){
            return String.format(FORMAT,(float)size/GB) + " GB";
        }else if(size < PB){
            return String.format(FORMAT,(float)size/TB) + " TB";
        }else if(size < EB){
            return String.format(FORMAT,(float)size/PB) + " PB";
        }else{
            return String.format(FORMAT,(float)size/EB) + " EB";
        }
    }
